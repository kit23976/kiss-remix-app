...
function Profile({
    ...
    name: string;
    biog: string;
    bgProd: string; // Updated this to bgProd
    userIcon: string;
    userName: string;
    createdAt: string;
    active: boolean;
    ...
    return (
      <div className="max-w-sm lg:max-w-full lg:flex p-3 mt-3 rounded-xl">
        <div
          ...
          style={{ backgroundImage: `url(${bgProd})` }} // Updated this to bgProd
  ...
  export default function CardDetails() {
    ...
    const cardItems = items.map((cardItem, index) => (
      <Profile
        ...
        id={cardItem.id}
        name={cardItem.name}
        biog={cardItem.bio} // Changed to bio to match your data
        bgProd={cardItem.bgProd} // Updated this to bgProd
